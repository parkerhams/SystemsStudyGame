...
Shader "SNB_Nature/SNB_Grass"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_1 = (9.18).xx;
			float2 uv_TexCoord184 = i.uv_texcoord * temp_cast_0 + temp_cast_1;
			float simplePerlin2D186 = snoise( uv_TexCoord184 );
			float smoothstepResult190 = smoothstep( 0.59 , 0.61 , simplePerlin2D186);
			float4 lerpResult194 = lerp( _FlowerMainColor02 , _FlowerMainColor01 , smoothstepResult190);
			float4 lerpResult199 = lerp( float4( 0,0,0,0 ) , lerpResult194 , tex2DNode185.b);
			float4 lerpResult196 = lerp( _FlowerInsideColor02 , _FlowerInsideColor01 , smoothstepResult190);
			...
			float temp_output_157_0 = 0.0;
			o.Metallic = temp_output_157_0;
			o.Smoothness = temp_output_157_0;
			o.Alpha = 1;
...
/*ASEBEGIN
Version=16100
7;1109;1906;1004;3300.514;818.804;1.346702;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;181;-2756.402,-701.373;Float;False;1750.334;1123.101;;18;199;198;197;196;195;194;193;192;191;190;189;188;187;186;185;184;183;182;Grass & Flower Color Variation;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-2751.54,-1104.126;Float;False;Property;_HeightStartGradient;Height Start Gradient;8;0;Create;True;0;0;False;0;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;-2708.552,321.2034;Float;False;Constant;_FlowerTilingOffset;Flower Tiling Offset;10;0;Create;True;0;0;False;0;9.18;9.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;183;-2701.29,122.6612;Float;False;Constant;_FlowerTilingVariation;Flower Tiling Variation;9;0;Create;True;0;0;False;0;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;184;-2421.516,191.006;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;4,4;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;153;-2576.574,-951.2346;Float;False;Property;_HeightGradient;Height Gradient;9;0;Create;True;0;0;False;0;0.3;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;186;-2164.942,199.1454;Float;False;Simplex2D;1;0;FLOAT2;1,1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;190;-1946.946,197.1961;Float;False;3;0;FLOAT;0;False;1;FLOAT;0.59;False;2;FLOAT;0.61;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;191;-2703.704,-655.7825;Float;False;Property;_GrassColor;Grass Color;6;0;Create;True;0;0;False;0;0.5264154,0.7264151,0.2158686,0;0.4392356,0.735849,0.21173,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;187;-2702.605,-493.582;Float;False;Property;_HeightColor;Height Color;7;0;Create;True;0;0;False;0;0.4464056,0.6981132,0.1350124,0;0.554338,0.764151,0.2270825,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-1902.388,1653.194;Float;False;Property;_WindFoliageAmplitude;Wind Foliage Amplitude;2;0;Create;True;0;0;False;0;0;0.05;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=DD334DA19EF9D465DEAD35BBA1077C257E496E6B