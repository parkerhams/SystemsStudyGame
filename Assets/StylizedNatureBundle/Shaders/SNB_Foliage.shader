...
Shader "SNB_Nature/SNB_Foliage"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			s37.Albedo = tex2DNode36.rgb;
			float2 uv_NormalMap = i.uv_texcoord * _NormalMap_ST.xy + _NormalMap_ST.zw;
			s37.Normal = WorldNormalVector( i , UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap ), _NormalStrength ) );
			...
			s37.Emission = ( tex2DNode106.r * _EmissionStrength * tex2DNode36 ).rgb;
			s37.Metallic = tex2DNode106.g;
			s37.Smoothness = tex2DNode106.b;
			s37.Occlusion = 1.0;
			...
			#endif //aselc
			c.rgb = ( float4( surfResult37 , 0.0 ) + ( ( ( ( temp_output_39_0 * saturate( ( ase_lightAtten + ( 1.0 - _DirectionalShadows ) ) ) * ( 1.0 - isPointLight52 ) ) + ( temp_output_39_0 * _PointLightTranslucency * isPointLight52 * ase_lightAtten ) ) * 1.0 ) * ( tex2DNode36 * _TranslucencyTint * ase_lightColor * _TranslucencyForce ) ) ).rgb;
			c.a = 1;
...
/*ASEBEGIN
Version=16100
7;1109;1906;1004;3345.097;1704.903;2.543217;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-2098.592,248.5341;Float;False;Property;_DirectionalShadows;Directional Shadows;8;0;Create;True;0;0;False;0;0.2;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;131;-2752.534,1253.118;Float;False;Property;_WindTrunkSpeed;Wind Trunk Speed;13;0;Create;True;0;0;False;0;0;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-2624.162,2292.17;Float;False;Property;_WindFoliageSpeed;Wind Foliage Speed;11;0;Create;True;0;0;False;0;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;94;-2656.373,2122.75;Float;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-2187.593,1232.33;Float;False;Property;_WindTrunkAmplitude;Wind Trunk Amplitude;12;0;Create;True;0;0;False;0;0;0.06;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-2133.11,704.5453;Float;False;Property;_PointLightTranslucency;Point Light Translucency;9;0;Create;True;0;0;False;0;1;3;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;59;-1767.081,419.5862;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;146;-2117.948,-977.7754;Float;False;1272.888;652.4158;;6;104;108;107;106;36;105;Base Textures;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-1103.184,211.539;Float;False;Property;_TranslucencyForce;Translucency Force;7;0;Create;True;0;0;False;0;0.4;0.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;36;-1824.937,-545.4274;Float;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-1282.576,-559.5295;Float;False;Property;_EmissionStrength;Emission Strength;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;106;-1834.936,-750.888;Float;True;Property;_EmissionRMetallicGSmoothnessB;Emission (R), Metallic (G), Smoothness (B);1;0;Create;True;0;0;False;0;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;47;-1103.474,-167.1122;Float;False;Property;_TranslucencyTint;Translucency Tint;6;0;Create;True;0;0;False;0;1,0.9937924,0.3820755,0;1,0.9640312,0.1839615,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;98;-1658.111,2094.45;Float;False;Property;_WindFoliageAmplitude;Wind Foliage Amplitude;10;0;Create;True;0;0;False;0;0;0.05;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;104;-1830.615,-929.0303;Float;True;Property;_NormalMap;Normal Map;2;1;[Normal];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;-1032.287,-576.7852;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CustomStandardSurface;37;-633.8544,-736.3492;Float;False;Metallic;Tangent;6;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,1;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;1;False;1;FLOAT3;0
...
WireConnection;37;1;104;0
WireConnection;37;2;108;0
WireConnection;37;3;106;2
WireConnection;37;4;106;3
...
ASEEND*/
//CHKSM=723569C33D1C79EA73926E96632F91A7F1C2C8D8